/*
    ...
    Yoshifan101 made the edits after forking.
*/
...
public class Whitehole {
    public static final String NAME = "Whitehole v1.5.1";
    public static final String WEBURL = "http://lumasworkshop.bplaced.net/";
    public static final String CRASHURL = "http://lumasworkshop.bplaced.net/";
